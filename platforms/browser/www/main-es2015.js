...
class GrlistComponent {
    ...
    deleteItem(i) {
        ...
        var bookmarks = JSON.parse(localStorage.getItem('items'));
...
function HomeComponent_tr_12_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_tr_12_Template_button_click_2_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4); const item_r1 = ctx.$implicit; const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r3.onClickList(item_r1.listname); });
    ...
    const item_r1 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](item_r1.listname);
} }
class HomeComponent {
    ...
    addItem(listname) {
        ...
        if (listname) {
            this.items.push({ listname });
            console.log(this.items);
            this.lname = listname;
            console.log("Inside if condition- " + listname);
    ...
    deleteItem(i) {
        ...
        this.items.splice(i, 1);
        var bookmarks = JSON.parse(localStorage.getItem('list'));
        bookmarks.splice(i, 1);
        console.log("local data" + i + bookmarks);
...
HomeComponent.ɵfac = function HomeComponent_Factory(t) { return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_my_service_service__WEBPACK_IMPORTED_MODULE_3__["MyServiceService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }, { type: src_app_my_service_service__WEBPACK_IMPORTED_MODULE_3__["MyServiceService"] }]; }, null); })();
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 30, vars: 2, consts: [[1, "container"], [1, "row"], [1, "col-sm-9", "col-lg-4"], [1, "col-sm-9", "col-sm-offset-1", "col-lg-4"], [3, "formGroup", "ngSubmit"], [1, "mt-3"], [1, "formData"], [1, "mb-4", "ml-3"], [1, "form-group", "input-group"], [1, "input-group-prepend", "pre"], [1, "input-class-text"], [1, "fa", "fa-user", "fa-lg"], ["type", "email", "placeholder", "Email Id", "formControlName", "email", "name", "email", 1, "form-control"], [1, "fa", "fa-key", "fa-lg"], ["type", "password", "placeholder", "Password", "formControlName", "password", "name", "password", 1, "form-control"], [1, "center"], ["type", "submit", 1, "btn", "btn-block", "mb-3", "btnd"], ["type", "button", 1, "btn", "btn-block", "btnd"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
...
class MyServiceService {
    ...
    authlogin(username, password) {
        ...
        if (username == "monali" && password == "mn123") {
            localStorage.setItem("currentUser", "monali");
            return true;
        }
        else
            return false;
